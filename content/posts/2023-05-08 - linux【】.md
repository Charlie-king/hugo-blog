...
services:
    alist:
        restart: always
        volumes:
            - '/home/shjin/compose/alist:/opt/alist/data'
        ports:
            - '5244:5244'
        environment:
            - PUID=0
...
services:
  app:
    ...
    environment:
      ...
      # DISABLE_IPV6: 'true'
    volumes:
      - /home/shjin/compose/npm:/data
      - /home/shjin/compose/npm/letsencrypt:/etc/letsencrypt
    depends_on:
      - db
  ...
  db:
    ...
    environment:
      ...
      MYSQL_PASSWORD: 'npm'
    volumes:
      - /home/shjin/compose/mysql:/var/lib/mysql
...
services:
  tools:
    ...
    ports:
      - "6412:6412"
    volumes:
      - /home/shjin/compose/tools:/app/data
...
services:
  vaultwarden:
    ...
    ports:
      ...
      - "3012:3012"
    volumes:
      - /home/shjin/compose/vaultwarden/vw-data/:/data/
    restart: always
...
services:
  homepage:
    ...
    ports:
      - 3000:3000
    volumes:
      - /home/shjin/compose/homepage2/config:/app/config # Make sure your local config directory exists
